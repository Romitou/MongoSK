...
@Description({
    "Quickly retrieve all the collections contained within a specific Mongo database.",
    "Returns a list of MongoDB collections."
})
@Examples({
    "set {_collections::*} to all mongo collections of {mydatabase}",
